        ...
        <div className="flex gap-6">
          ...
          <div className="w-1/2">
            ...
            <div className="flex gap-3 mt-6">
              <button onClick={handleAddToCartClick} className="flex-1 rounded-lg bg-red-600 py-2.5 text-white font-semibold hover:bg-red-700 transition text-sm flex items-center justify-center gap-2">
      ...
      try {
        ...
        if (flashCampaign) {
          ...
          const transformedProducts = productsResponse.data.map((p, index) => ({
            ...
            rating: p.product_details?.rating || 4,
            ...
            campaign_name: flashCampaign.campaign_name,
            end_datetime: flashCampaign.end_datetime,
          ...
          const fallbackProducts = [
            {
              ...
              price: 2999,
              original_price: 5999,
              img: "https://placehold.co/400x400/f0f4f8/94a3b8?text=Smart+Watch",
              discount_percentage: 50,
              in_stock: true,
              vendor_name: "TechGiant",
              stocks: [{ id: 1, mrp: 5999, selling_price: 2999, final_price: 2999, maximum_order_quantity: 3 }],
              rating: 4.5,
              review_count: 256,
              category: 1,
              brand: 1
            },
            {
              ...
              price: 1499,
              original_price: 2999,
              img: "https://placehold.co/400x400/f0f4f8/94a3b8?text=Earbuds",
              discount_percentage: 50,
              in_stock: true,
              vendor_name: "AudioPro",
              stocks: [{ id: 2, mrp: 2999, selling_price: 1499, final_price: 1499, maximum_order_quantity: 5 }],
              rating: 4.3,
              review_count: 189,
              category: 2,
              brand: 2
          ...
          setCategories([
            ...
            { id: 2, name: "Audio", product_count: 8 }
          ]);
          setBrands([
            { id: 1, brand_name: "TechGiant", product_count: 5 },
            { id: 2, brand_name: "AudioPro", product_count: 3 }
          ]);
        }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-50 py-8 px-4">
        <div className="max-w-7xl mx-auto text-center py-16">
          <h2 className="text-3xl font-bold text-gray-800 mb-2">No Active Flash Deals</h2>
          <p className="text-gray-600 mb-6">Check back later for exciting flash sales!</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-50 to-blue-50 py-8 px-4">
      ...
      <MobileFilterSidebar
        ...
        title="Flash Deal Filters"
      />

      <div className="max-w-7xl mx-auto">
        {/* FANCY FLASH DEAL COUNTDOWN HEADER */}
        <div className="relative mb-12 overflow-hidden rounded-3xl bg-gradient-to-r from-red-600 via-orange-500 to-yellow-500 shadow-2xl">
          {/* Lightning Effects */}
          <div className="absolute inset-0 opacity-20">
            <div className="absolute top-0 left-1/4 w-64 h-64 bg-yellow-300 rounded-full filter blur-3xl animate-pulse"></div>
            <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-red-300 rounded-full filter blur-3xl animate-pulse delay-700"></div>
          </div>
          ...
          <div className="absolute inset-0 overflow-hidden">
            {[...Array(10)].map((_, i) => (
              <div
                key={i}
                className="absolute text-yellow-200/30 text-4xl animate-pulse"
                style={{
          ...
          <div className="relative p-8 md:p-12 text-white">
            ...
            <div className="flex justify-center mb-6">
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-lg px-6 py-2 rounded-full border border-white/30 shadow-lg">
                <FiZap className="h-5 w-5 text-yellow-300 animate-pulse" />
                <span className="font-semibold text-lg">FLASH SALE - LIMITED TIME</span>
            ...
            {/* Subtitle */}
            <p className="text-center text-lg md:text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              Lightning deals with massive discounts!
            </p>
            ...
            <div className="flex flex-col items-center">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xl font-semibold text-white/90">Hurry! Sale ends in</span>
              </div>
              ...
              <div className="flex gap-4 md:gap-6 flex-wrap justify-center">
                ...
                <div className="relative">
                  <div className="w-24 h-24 md:w-28 md:h-28 bg-white/10 backdrop-blur-lg rounded-2xl border-2 border-white/30 shadow-xl flex flex-col items-center justify-center transform hover:scale-105 transition-transform">
                    ...
                    <div className="text-xs md:text-sm text-orange-200 font-medium mt-1">DAYS</div>
                  </div>
                  <div className="absolute -top-2 -right-2 w-6 h-6 bg-red-400 rounded-full flex items-center justify-center text-white font-bold text-xs animate-pulse">
                    D
                  </div>
                </div>
                ...
                <div className="relative">
                  <div className="w-24 h-24 md:w-28 md:h-28 bg-white/10 backdrop-blur-lg rounded-2xl border-2 border-white/30 shadow-xl flex flex-col items-center justify-center transform hover:scale-105 transition-transform">
                    ...
                    <div className="text-xs md:text-sm text-orange-200 font-medium mt-1">HOURS</div>
                  </div>
                  <div className="absolute -top-2 -right-2 w-6 h-6 bg-orange-400 rounded-full flex items-center justify-center text-white font-bold text-xs animate-pulse">
                    H
                  </div>
                </div>
                ...
                <div className="relative">
                  <div className="w-24 h-24 md:w-28 md:h-28 bg-white/10 backdrop-blur-lg rounded-2xl border-2 border-white/30 shadow-xl flex flex-col items-center justify-center transform hover:scale-105 transition-transform">
                    ...
                    <div className="text-xs md:text-sm text-orange-200 font-medium mt-1">MINUTES</div>
                  </div>
                  <div className="absolute -top-2 -right-2 w-6 h-6 bg-yellow-400 rounded-full flex items-center justify-center text-white font-bold text-xs animate-pulse">
                    M
                  </div>
                </div>
                ...
                <div className="relative">
                  <div className="w-24 h-24 md:w-28 md:h-28 bg-white/10 backdrop-blur-lg rounded-2xl border-2 border-white/30 shadow-xl flex flex-col items-center justify-center transform hover:scale-105 transition-transform">
                    ...
                    <div className="text-xs md:text-sm text-orange-200 font-medium mt-1">SECONDS</div>
                  </div>
                  <div className="absolute -top-2 -right-2 w-6 h-6 bg-green-400 rounded-full flex items-center justify-center text-white font-bold text-xs animate-pulse">
                    S
                  </div>
                </div>
              </div>
              ...
              {/* Progress Bar */}
              {flashDeal?.start_datetime && (
                <div className="w-full max-w-2xl mt-8">
                  <div className="h-2 bg-white/20 rounded-full overflow-hidden">
                    <div
                      className="h-2 bg-gradient-to-r from-yellow-300 to-red-300 rounded-full transition-all duration-1000"
                      style={{
                  ...
                  <p className="text-center text-sm text-orange-200 mt-2">
                    {Math.round((new Date(flashDeal.end_datetime).getTime() - new Date().getTime()) / (1000 * 60))} minutes remaining
                  </p>
                </div>
              )}
              ...
              <div className="mt-8 flex gap-6 flex-wrap justify-center">
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
                  ...
                  <span className="text-sm font-medium">{products.length} Flash Deals</span>
                </div>
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
                  <FiPercent className="text-red-300" />
              ...
              {upcomingDeals?.next_deal && (
                <div className="mt-6 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full border border-white/20">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm">Next Flash Deal in: </span>
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
            <div className="flex flex-col md:flex-row justify-between items-center gap-3">
              <div className="text-sm font-medium text-gray-600 order-2 md:order-1 whitespace-nowrap w-full md:w-auto">
                <span className="font-bold text-gray-900">{filteredProducts.length}</span> Flash Deals Found
              </div>
              ...
              <div className="flex items-center gap-3 w-full order-1 md:order-2">
                ...
                <div className="relative flex-1">
                  ...
                  />
                  <button className="absolute right-0 top-0 bottom-0 px-4 bg-gradient-to-r from-blue-500 to-blue-500 rounded-r-xl text-white hover:from-blue-600 hover:to-blue-600 transition">
          ...
          {(selectedCategories.length > 0 || selectedBrands.length > 0 || minPrice > 0 || maxPrice < 200000) && (
            <div className="mt-4 p-3 bg-gradient-to-r from-red-50 to-orange-50 rounded-xl border border-red-200">
              ...
              <div className="flex flex-wrap gap-2">
                {minPrice > 0 && (
                  <span className="text-xs bg-red-100 text-red-800 px-3 py-1.5 rounded-full flex items-center gap-1">
                    Min: ₹{minPrice}
                  </span>
                )}
                {maxPrice < 200000 && (
                ...
                {selectedCategories.map(catId => {
                  ...
                  return category && (
                    <span key={catId} className="text-xs bg-red-100 text-blue-800 px-3 py-1.5 rounded-full flex items-center gap-1">
                      {category.name}
                      <button
                ...
                {selectedBrands.map(brandId => {
                  ...
                  return brand && (
                    <span key={brandId} className="text-xs bg-red-100 text-blue-800 px-3 py-1.5 rounded-full flex items-center gap-1">
                      {brand.brand_name}
                      <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <aside className="hidden md:block md:col-span-1 bg-white p-6 rounded-xl shadow-lg border border-gray-200 h-fit self-start sticky top-6">
            <h3 className="font-bold text-lg mb-6 text-gray-800 border-b pb-3">Filter Flash Deals</h3>
          ...
          <div className="md:col-span-3">
            {error ? (
              ...
              <div className="text-center py-16 bg-white rounded-xl shadow-lg border-2 border-dashed border-gray-300">
                <h3 className="text-2xl font-bold text-gray-800 mb-2">No Flash Deals Found</h3>
                <p className="text-gray-600 mb-6 max-w-md mx-auto">
                  {searchTerm || selectedCategories.length > 0 || selectedBrands.length > 0 || minPrice > 0 || maxPrice < 200000
                    ...
                    : "Check back later for exciting flash sales!"}
                </p>
                <button
                  onClick={() => {
                    setSearchTerm("");
                  ...
                  className="px-6 py-2.5 bg-gradient-to-r from-blue-500 to-blue-500 text-white rounded-xl hover:from-blue-600 hover:to-blue-600 transition font-medium"
                >
                  Clear Filters
                </button>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                {filteredProducts.map((product) => (
                  <div
                    ...
                    className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group border border-gray-100 hover:border-blue-200 relative"
                  >
                    {/* Flash Badge */}
                    ...
                    <div className="relative h-48 bg-gradient-to-br from-blue-50 to-blue-50 overflow-hidden">
                      ...
                      {product.in_stock ? (
                        ...
                        <div className="absolute bottom-2 left-2 bg-blue-100 text-blue-700 text-xs px-2 py-1 rounded-full">
                          Out of Stock
                        </div>
                      )}
                    </div>
                    ...
                    <div className="p-4">
                      ...
                      {/* Timer Badge */}
                      <div className="flex items-center gap-1 text-xs text-blue-600 bg-blue-50 px-2 py-1 rounded-full w-fit mb-3">
                      ...
                      <button
                        onClick={(e) => openModal(product, e)}
                        className="w-full mt-2 bg-gradient-to-r from-blue-500 to-blue-500 hover:from-blue-600 hover:to-blue-600 text-white py-2.5 rounded-lg font-medium text-sm transition-all duration-300 transform hover:scale-[1.02] shadow-md hover:shadow-lg flex items-center justify-center gap-2 group/btn"
                      >
                        <FiZap className="h-4 w-4 group-hover/btn:rotate-12 transition-transform" />
                        Grab Deal
                      </button>
                    </div>
                  </div>
...
export default FlashDealListPage;