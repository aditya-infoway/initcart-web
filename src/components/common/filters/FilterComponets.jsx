...
export const FilterSection = ({ title, children, isExpanded = true }) => {
    ...
    return (
        <div className="border-b border-gray-200 py-4 last:border-b-0">
            ...
            <div
                className={`overflow-hidden transition-all duration-500 ease-in-out ${expanded ? "max-h-96 pt-3" : "max-h-0"}`}
            >
                {children}
            </div>
        </div>
    ...
    return (
        <div className="mt-4">
            ...
            <div className="relative h-2 rounded-full bg-gray-200">
                <div
                    className="absolute h-2 bg-gradient-to-r from-blue-500 to-blue-700 rounded-full"
                    style={{
