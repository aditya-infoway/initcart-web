// src/pages/mobile/MobileProfessionalHome.tsx
...
export default function MobileProfessionalHome() {
        ...
        <section key={`${blockIndex}-${index}`} className="py-5">
          <div className="flex justify-between items-center mb-4 px-1">
            ...
            <button
              ...
              className="text-indigo-600 text-[11px] font-semibold flex items-center gap-1"
              style={{ fontFamily: "'Inter', sans-serif" }}
            >
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen pb-20" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="sticky top-0 z-40 bg-white/80 backdrop-blur-lg border-b border-gray-100 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-500">Trusted experts</p>
          </div>
        </div>
      ...
      <section className="relative mx-3 mt-3 rounded-3xl overflow-hidden h-[250px]">
        <img
          src={bigAd?.image || "https://images.pexels.com/photos/4307872/pexels-photo-4307872.jpeg?auto=compress&cs=tinysrgb&w=800"}
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-4">
          ...
          <p className="text-indigo-200 text-[10px] mt-0.5" style={{ fontFamily: "'Inter', sans-serif" }}>
            <span className="font-bold text-white">500+</span> verified professionals
          </p>
          ...
          <div className="mt-2.5 bg-white rounded-2xl shadow-xl p-1.5 flex items-center gap-1.5 relative z-10">
            ...
            <div className="flex-[2] min-w-[100px]">
              <input
                type="text"
                placeholder="Search CA, Lawyer, Architect..."
                value={searchKeyword}
                onChange={(e) => setSearchKeyword(e.target.value)}
                onKeyPress={(e) => e.key === 'Enter' && navigateToServiceList()}
                className="w-full px-3 py-2 text-[10px] bg-gray-50 rounded-xl outline-none focus:ring-2 focus:ring-indigo-500 transition"
                style={{ fontFamily: "'Inter', sans-serif" }}
              />
            </div>
            ...
            <button
              ...
              className="px-3.5 py-2 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white text-[10px] font-semibold rounded-xl hover:shadow-lg transition flex-shrink-0"
              style={{ fontFamily: "'Inter', sans-serif" }}
            >
              <FiSearch size={14} />
            </button>
        ...
        <div className="relative px-3 -mt-1 z-[9999]">
          <div className="w-full bg-white shadow-2xl rounded-xl max-h-52 overflow-y-auto border border-gray-200">
            ...
            {cities.map((city, idx) => (
              <div
                key={city.id || idx}
                className="px-3 py-2.5 text-[11px] hover:bg-indigo-50 cursor-pointer text-gray-700 transition flex items-center justify-between"
                onClick={() => {
      ...
      <div className="px-3 py-4">
        ...
        <section className="grid grid-cols-3 gap-2.5 mb-5">
          {[
            { icon: <FaFileInvoiceDollar className="text-xl text-indigo-600" />, title: "CA", count: "100+" },
            { icon: <FaBalanceScale className="text-xl text-green-600" />, title: "Lawyer", count: "80+" },
            { icon: <FaHardHat className="text-xl text-pink-600" />, title: "Architect", count: "60+" },
          ].map((item, i) => (
            <div
              key={i}
              onClick={navigateToServiceList}
          ...
          <section className="py-3">
            <div className="relative rounded-2xl overflow-hidden shadow-sm h-36 group cursor-pointer" onClick={() => window.open(bigAd.url, "_blank")}>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-3.5">
                ...
                <button className="inline-block mt-1 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white text-[10px] font-medium px-3.5 py-0.5 rounded-full hover:shadow-lg transition">
                  Learn More →
                </button>
              </div>
            </div>
        ...
        {/* <section className="py-5">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-[15px] font-bold text-gray-900">Client Reviews</h2>
            <button className="text-[11px] text-indigo-600 font-semibold">See All →</button>
          </div>
...
const ServiceCard = ({ service, onInquiry, navigateToDetail }) => {
  return (
    <div className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden border border-gray-100">
      ...
      >
        <img
          src={service.main_image || "https://placehold.co/400x300/indigo/white?text=Professional"}
      ...
      <div className="p-3">
        ...
        <p 
          className="text-[9px] text-indigo-600 font-medium truncate"
          style={{ fontFamily: "'Inter', sans-serif" }}
        >
        ...
        <div className="flex gap-1.5 mt-2">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white text-[9px] font-medium py-1.5 rounded-lg hover:shadow-md transition"
            style={{ fontFamily: "'Inter', sans-serif" }}
          >
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3 w-full">
              ...
              <div className="mt-2 px-1 w-full">
                {field.type === 'textarea' ? (
                  <textarea
                    ...
                    rows="3"
                    className="w-full px-4 py-3 text-[13px] border-2 border-indigo-500 rounded-xl outline-none resize-none focus:ring-2 focus:ring-indigo-300 transition"
                    style={{ fontFamily: "'Inter', sans-serif" }}
                    autoFocus
                  />
                ) : (
                  <input
                    ...
                    value={value}
                    onChange={handleChange}
                    className="w-full px-4 py-3 text-[13px] border-2 border-indigo-500 rounded-xl outline-none focus:ring-2 focus:ring-indigo-300 transition"
                    style={{ fontFamily: "'Inter', sans-serif" }}
                    autoFocus
                  />
                )}
      ...
      <button
        type="submit"
        disabled={submitting}
        className="w-full py-3.5 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white rounded-xl font-semibold text-[13px] disabled:opacity-50 hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 mt-4"
        style={{ fontFamily: "'Inter', sans-serif" }}
      >
        {submitting ? (
          <>
