// src/pages/mobile/MobileTravelAgencyDetail.tsx
...
export default function MobileTravelAgencyDetail() {
  const { id } = useParams();
  ...
  if (loading) {
    return (
      <div className="flex flex-col justify-center items-center h-screen bg-gray-50">
        ...
        <span className="mt-3 text-detail-body text-gray-600">Loading travel service details...</span>
      </div>
    );
  }
    ...
    return (
      <div className="flex flex-col justify-center items-center h-screen bg-gray-50 px-4">
        ...
        <button
          ...
          className="bg-blue-600 text-white px-6 py-2 rounded-lg text-detail-btn-sm hover:bg-blue-700"
        >
    ...
    <div className="bg-gray-50 min-h-screen pb-24 overflow-x-hidden" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="relative mx-3 mt-3 rounded-2xl overflow-hidden">
        ...
        {service.subcategory_name && (
          <span className="absolute top-3 left-3 bg-blue-600 text-white text-detail-xs font-medium px-2.5 py-1 rounded-full">
            {service.subcategory_name}
          </span>
        )}
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
              <h2 className="text-detail-subtitle font-bold text-gray-900 mb-2 flex items-center gap-2">
                <FiPackage className="text-blue-600 text-detail-icon-sm" /> About
              </h2>
            ...
            {items.length > 0 && (
              <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                <h2 className="text-detail-subtitle font-bold text-gray-900 mb-3 flex items-center gap-2">
                  <FiPackage className="text-blue-600 text-detail-icon-sm" /> Services & Packages
                </h2>
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        {formatCurrency(item.price) && (
                          <div className="ml-2 flex-shrink-0">
                            <span className="text-blue-600 font-bold text-detail-price">{formatCurrency(item.price)}</span>
                          </div>
                        )}
                      </div>
                    </div>
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  { icon: FiTag, label: "Category", value: service.subcategory_name || "Travel" },
          ...
          <div className="space-y-4">
            ...
            {service.location && (
              <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                ...
                <a href={service.location} target="_blank" rel="noopener noreferrer" className="text-blue-600 text-detail-text break-all hover:text-blue-800">
                  {service.location}
                </a>
              </div>
            )}
            ...
            <form onSubmit={handleInquirySubmit} className="space-y-3 w-full">
              ...
              >
                {submitting ? (
                  ...
                  <>
                    <FiPackage className="text-detail-icon-sm" /> Send Inquiry
                  </>
                )}
              </button>
            </form>
