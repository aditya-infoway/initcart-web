...
// ✅ IMPORT ADDED - Reviews Display Component
import ServiceReviewsDisplay from "./ServiceReviewsDisplay";

export default function HotelHome2() {
  ...
  // ✅ STATE ADDED - Reviews ke liye service list
  ...
  useEffect(() => {
    const fetchServices = async () => {
      ...
      try {
        ...
        // ✅ Reviews ke liye service list banao
        ...
        {loading ? (
          ...
          <>
            ...
            {renderBlock(blockThree)}
              ...
              {/* ✅ REVIEWS SECTION ADDED - Categories se pehle */}
